...
public:
     ...
     */
    virtual void AddLine( const wxRealPoint& aOrigin, const wxRealPoint& aEnd ) = 0;
     ...
     */
    virtual void AddCircle( const wxRealPoint& aCenter, unsigned int aRadius ) = 0;
     ...
     */
    virtual void AddArc( const wxRealPoint& aCenter, const wxRealPoint& aStart,
            double aAngle ) = 0;

    virtual void AddPolygon( const std::vector< wxRealPoint >& aVertices ) = 0;

    //virtual void AddArc( const wxRealPoint& aOrigin, double aStartAngle, double aEndAngle ) = 0;
    //
    /**
     ...
     */
    virtual void AddText( const wxRealPoint& aOrigin, const wxString& aText,
